...
# PROP Scc_ProjName ""$/UDP_P2P/NetServer", FQECAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"../bin/NetServer.exe"
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"../bindbg/NetServer.exe" /pdbtype:sept
